...
<%@include file="/WEB-INF/jsp/common/head.jsp"%>
    <div class="right">
        ...
        <form id="userForm" name="userForm" method="post" action="${pageContext.request.contextPath }/sys/user/updateUser.html">
			...
			<input type="hidden" name="id" value="${user.id }"/>
			 ...
			 <div>
                    ...
                    <fmt:formatDate value="${user.birthday }" var="birthday" pattern="yyyy-MM-dd" />
